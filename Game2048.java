...
public class Game2048 {
    ...
    public void start() {
        ...
        String inputSize = JOptionPane.showInputDialog(frame, constant.ENTER_GRID_SIZE, "Grid Size",
        ...
        frame.addKeyListener(new KeyAdapter() {
            ...
            public void keyPressed(KeyEvent e) {
                ...
                moved = false;
                switch (key) {
                    case KeyEvent.VK_W, KeyEvent.VK_I, KeyEvent.VK_UP -> moveUp();
                    case KeyEvent.VK_A, KeyEvent.VK_J, KeyEvent.VK_LEFT -> moveLeft();
                    case KeyEvent.VK_S, KeyEvent.VK_K, KeyEvent.VK_DOWN -> moveDown();
                    case KeyEvent.VK_D, KeyEvent.VK_L, KeyEvent.VK_RIGHT -> moveRight();
